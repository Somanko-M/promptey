...
if (possible && !possible.includes("<html") && !possible.includes("<style") && !possible.includes("<script>")) {
  enhancedPrompt = possible;
} else {
  console.warn("⚠️ Enhancement returned code instead of prompt. Using original prompt.");

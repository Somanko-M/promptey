        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/prompt-builder" className="text-muted-foreground hover:text-primary transition-colors">AI Builder</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/press" className="text-muted-foreground hover:text-primary transition-colors">Press Kit</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/status" className="text-muted-foreground hover:text-primary transition-colors">System Status</Link></li>
